...
public class nmy_Slot : MonoBehaviour
{
    ...
    public nmy_Item item;
    [SerializeField]
    public Image itemIcon;
    public bool isEquip = false;
    public static List<nmy_Item> equipedItem;
    [SerializeField]
    ...
    public void AddItem(nmy_Item _item, int _count = 1)
    {
        item = _item;
        itemCount = _count;
        itemIcon.sprite = item.itemImage;

        if (item.itemType != nmy_Item.ItemType.Equip)
        {
    ...
    void Equipment()
    {
        nmy_Item _equipItem = equipedItem[0];
